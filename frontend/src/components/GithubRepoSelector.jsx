...
const GithubRepoSelector = () => {
  ...
  if (loading) {
    return (
      <p className="text-sm text-gray-500">Loading GitHub repositories…</p>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
        <div className="text-center space-y-3 max-w-md">
          ...
          <p className="text-sm text-gray-600">Please connect your GitHub account to select a repository</p>
          <button
